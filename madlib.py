# Prolog: Project
# Author:  Ryan Bouapheng & Zain Jessani
# Email:  rbouapheng1@student.gsu.edu & @student.gsu.edu
# Section: 004, CSC1301 
...
def newgame(choice):               # reiterates game
    ...
    if choice == "school":
        ...
        """.format(verb_1, noun_1, color_1, adj_1, verb_2, noun_2, adj_2, noun_1, noun_2, noun_3, adj_1 ,place_1))
        print(school)
        return newgame(choice)
